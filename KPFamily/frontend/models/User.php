...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(BonPadi::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(BonProduk::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(PinjamanCustomer::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(PinjamanKaryawan::className(), ['id_user' => 'id']);
    }
}
